...
from database.inventario import obtener_inventario_general, obtener_stock
...
def test_inventario_y_validaciones_del_requisito_hackathon():
    ...
    assert obtener_stock(c2['id'], camp['id'], art['id']) == 20.0
    inventario_general = obtener_inventario_general()
    assert inventario_general[camp['id']][art['id']] == 65.0
